...
;
soh     EQU     1       ;ASCII SOH (Control-A)
cntlc	EQU	3	;ASCII ETX (Control-C)
ctrlc   EQU     3       ;ASCII ETX (Control-C)
bell    EQU     7       ;ASCII BEL (Control-G)
bs      EQU     8       ;ASCII backspace (Control-H)
tab     EQU     9       ;ASCII Tab (Control-I)
lf      EQU     10      ;ASCII Line Feed (CTRL-J)
ff      EQU     12      ;ASCII Form Feed (CTRL-L)
cr      EQU     13      ;ASCII Carriage Return (CTRL-M)
space	EQU	20h	;ASCII Space
xon     EQU     17      ;ASCII XON (Control-Q)
xoff    EQU     11      ;ASCII XOFF (Control-S)
esc     EQU     27      ;ASCII ESCape
semico	EQU	3bh	;ASCII Semicolon
subt    EQU     26      ;ASCII SUB (CTRL-Z)
cntlz   EQU     subt    ;ASCII SUB (Control-z) [6]
ctrlz	EQU	subt	;ASCII SUB (Control-z)
del     EQU     127     ;ASCII DELete (rubout)
;
;BDOS calls
