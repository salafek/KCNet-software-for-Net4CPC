...
; revision history:
;
;edit 12, 21-Nov-2022 by D. Kefalas Added Net4CPC Interface description
;
;edit 11, 21-Jun-2009 by R. Kästner Added code to support the KC(85)Net-Interface
;
...
swtver:	db	'CPXSWT.ASM (11) 21-Jun-2009 $'
;
...
IF (k85fam AND lasm)
; Link to the kc85n family file
.printx * linking to the KC(85)Net family file *
LINK CPXK85.ASM
ENDIF	; (k85fam AND lasm) - m80 use: INCLUDE from CPXTYP.ASM
...
IF kc85n
.printx * Assembling Kermit-80 for the Net4CPC *
ENDIF	;kc85n
